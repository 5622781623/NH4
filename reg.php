              ...
              <div class="box">
                 <!-- HEADER -->
                    ...
                    <section>
                       ...
                       <hr>
                       <div class="line">
                          <form action="regg.php" method="POST"class="customform">

                            <div class="margin">
                              <div class="s-12 l-6"><h5>Group Name</h5>
                                <input placeholder="Group name" title="Group name" type="text" name="gname" required/>
                              </div>
                            </div>
                             ...
                             <article class="line">
                                <div class="margin">
                                  <h5>Member</h5>
                                  <div class="s-12 l-6"><input name="namemember1" placeholder="Name" title="Name" type="text" required/></div>
                                  <div class="s-12 l-6"><input name="studentid1" placeholder="ID" title="ID" type="text" required/></div>

                                  <div class="s-12 l-6"><input name="namemember2" placeholder="Name" title="Name" type="text" required/></div>
                                  <div class="s-12 l-6"><input name="studentid2" placeholder="ID" title="ID" type="text" required/></div>
                             ...
                             <div class="line">
                                <div class="margin">
                                  <div class="s-12 l-6">
                                    <h5>Email</h5>
                                    <input name="email" placeholder="name@domain.com" title="e-mail" type="text" required></div>
                                </div>
                             </div>
                             ...
                             <div class="margin">
                               <div class="s-12 l-6">
                                <h5>Password</h5>
                               <input type="password" name="password" placeholder="Password"id="password" maxlength="8" required>
                             </div>
                             </div>

                             <div class="line">
                               <div class="margin">
                                 <div class="s-12 l-6"><h5>Group averaged GPA</h5><input name="gpa" placeholder="GPA" title="GPA" type="text" required/></div>
